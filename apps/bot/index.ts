...
-----END RSA PRIVATE KEY-----`.trim(),
  ...
  clientSecret: process.env.GITHUB_CLIENT_SECRET || 'b36f3f64a82f21f19f855c77ee6bd92882a31ade',
};
...
const webhookHandlers = new WebhookHandlers(githubApp, buildService, repositoryService);
...
app.post('/webhooks/github', async (c) => {
  try {
    ...
    await webhookHandlers.logWebhookEvent(eventType, payload, payload.repository?.id);
